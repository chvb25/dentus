                    ...
                    <form class="form-horizontal" action="{{ url('update-patients') }}/{{ $pts->id }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row justify-content-start">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="name" placeholder="Name Here" value="{{ $pts->name }}" required>
                                </div>
                                <label for="lastName" class="col-sm-1 text-right control-label col-form-label label-required">Last Name</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="lastName" placeholder="Last Name Here" value="{{ $pts->lastName }}" required>
                                </div>
                            </div>
                            <div class="form-group row justify-content-start">
                                <label for="dni" class="col-sm-1 text-right control-label col-form-label label-required">DNI</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="dni" placeholder="DNI Here" value="{{ $pts->dni }}" required>
                                </div>
                            ...
                            <div class="form-group row justify-content-start">
                                ...
                                <div class="col-sm-5">
                                    <textarea name="address" class="form-control" cols="30" rows="5" placeholder="Address Here" required>{{ $pts->address }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row justify-content-start">
                                <label for="profession" class="col-sm-1 text-right control-label col-form-label label-required">Profession</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="profession" placeholder="Profession Here" value="{{ $pts->profession }}" required>
                                </div>
                                <label for="jobTitle" class="col-sm-1 text-right control-label col-form-label label-required">Job Title</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="jobTitle" placeholder="Job Title Here" value="{{ $pts->jobTitle }}" required>
                                </div>
                            </div>
                            <div class="form-group row justify-content-start">
                                <label for="jobAddress" class="col-sm-1 text-right control-label col-form-label label-required">Job Address</label>
                                <div class="col-sm-5">
                                    <textarea name="jobAddress" class="form-control" cols="30" rows="5" placeholder="Job Address Here" required>{{ $pts->jobAddress }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group row justify-content-center">
                                    <div class="col-sm-5">
                                        ...
                                        <button type="button" class="btn btn-danger" onclick="window.location.pathname =  '/patients'"><i class="mdi mdi-undo"></i> Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </div>
