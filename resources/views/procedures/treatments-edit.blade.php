                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row justify-content-start">
                                ...
                                <div class="col-sm-5">    
                                    ...
                                    <input type="text" data-provide="typeahead" class="form-control typeahead" name="name" placeholder="Search patients..." autocomplete="off" value="{{ $treatment->patient->completeName }}" required>
                                </div>                                                                
                            </div>
                            <div class="form-group row justify-content-start">
