...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" action="{{ url('update-treatments') }}/{{ $treatment->id }}" method="post">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="card-body">
                            ...
                            <div class="form-group row justify-content-start">
                                ...
                                <div class="col-sm-5">
                                    <input type="hidden" name="patient_id" id="patient_id" value="{{ $treatment->patients_id }}">
                                    <input type="hidden" name="quote_id" id="quote_id" value="{{ $treatment->quote_id }}">
                                    <input type="hidden" name="status" id="status" value="{{ $treatment->status }}">
                                    <input type="text" data-provide="typeahead" class="form-control typeahead" name="name" placeholder="Buscar Pacientes..." autocomplete="off" value="{{ $treatment->patient->completeName }}" required>
                                </div>
                            </div>
                            <div class="form-group row justify-content-start">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        <input type="text" class="form-control" name="date" placeholder="dd/mm/yyyy" value="{{ date('d/m/Y', strtotime($treatment->date)) }}" id="datepicker">
                            ...
                            <div class="form-group row justify-content-start">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="subtotal" id="subtotal" value="{{ $treatment->sub_total }}" readonly>
                                        <div class="input-group-append">
                            ...
                            <div class="form-group row justify-content-start">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="discount" name="discount" value="{{ $treatment->discount }}">
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">$</span>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row justify-content-start">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="total" name="total" value="{{ $treatment->final_price }}" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">$</span>
                                        </div>
                                    </div>
