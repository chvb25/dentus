                    ...
                    <form class="form-horizontal" action="{{ url('update-procedures') }}/{{ $procedure->id }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row justify-content-start">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="name" value="{{ $procedure->name }}" required>
                                </div>
                            </div>
                            <div class="form-group row justify-content-start">
                            ...
                            <div class="form-group row justify-content-start">
                                    <label for="type" class="col-sm-2 text-right control-label col-form-label label-required">Tipo</label>
                                    <div class="col-sm-5">
                                        <select name="types" class="select2 form-control custom-select select2-hidden-accessible">
                                            <option value="P" {{ ($procedure->type == "P") ? 'selected' : '' }}>Cara</option>
                                            <option value="F" {{ ($procedure->type == "F") ? 'selected' : '' }}>Pieza entera</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row justify-content-start">
